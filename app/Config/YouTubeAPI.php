...
class YouTubeAPI
{
    ...
    public $string = '&maxResults=50&part=id,snippet&fields=pageInfo,items(id,snippet(title,playlistId,position,publishedAt,description,resourceId(videoId)))';

    public $string_next = '&maxResults=50&pageToken=nextPageToken&part=id,snippet&fields=items(id,snippet(title,playlistId,position,publishedAt,description,resourceId(videoId)),pageInfo)';
}