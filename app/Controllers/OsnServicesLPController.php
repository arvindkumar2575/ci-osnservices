...
class OsnServicesLPController extends BaseController
{
    protected $settings;
    protected $common;
    ...
    public function index()
    {
        ...
        return view(OSNSERVICES_VIEW.'/index',$data);
    }
    ...
    public function aboutUs()
    {
        ...
        // echo '<pre>';print_r($data);die;
        return view(OSNSERVICES_VIEW.'/about-us',$data);
    }
    ...
    public function contactUs()
    {
        ...
        return view(OSNSERVICES_VIEW.'/contact-us',$data);
    }
    ...
    public function contactFormSubmit()
    {
        ...
        if($form_type=='ITR_Filing_Form' && $this->request->isAJAX()){
